...
public class JiraIssueAssignee {
    ...
    public JiraIssueAssignee(){}

    public JiraIssueAssignee(String key, String self, String name, JiraAvatarUrls avatarUrls, String emailAddress, String displayName, Boolean active, String timeZone) {
        this.mKey = key;
        this.mSelf = self;
        this.mName = name;
