...
/**
 * Created by Ivan_Bakach on 27.04.2015.
 */
class RoundRectDrawableWithShadowOwn extends Drawable {
    ...
    * */
    ...
    RoundRectDrawableWithShadowOwn(Resources resources, int backgroundColor, float radius,
